...
IF( WIN32 )
   ...
   IF( NOT USE_QUIET )
      SET( USER_COMMON_FLAGS_OPTION "/EHsc /W3 /wd4355 /wd4800 /wd4267 /wd4244 /wd4200" )
   ENDIF()
ELSE()
   SET( USER_COMMON_FLAGS_OPTION "-pipe -fno-builtin-memcmp -fPIC -fno-strict-aliasing -fcheck-new" )
   IF( NOT USE_QUIET )
