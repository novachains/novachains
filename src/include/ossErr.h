...
#define SDB_LOB_LOCK_CONFLICTED          -320  /**< LOB lock is conflicted */
#define SDB_DMS_TRUNCATED                -321  /**< Collection is truncated */
#define SDB_RTN_CONF_NOT_TAKE_EFFECT     -322  /**< Some configuration changes didn't take effect */
#endif /* OSSERR_H_ */